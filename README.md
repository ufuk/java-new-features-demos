...
| **Java 25**  | **LTS** | Flexible constructor bodies (GA), Module import declarations (GA), Primitive types in patterns (GA), Scoped values (GA), Compact Object Headers (GA), Structured Concurrency API evolution (preview - `open` & `Joiner`) | [`Java25Tests.java`](src/test/java/io/github/ufuk/java25/Java25Tests.java) |
| **Java 26**  | Non-LTS | Structured Concurrency Joiner API simplification (`anySuccessfulOrThrow`), Value objects & primitive classes (Valhalla preview), Leyden AOT optimizations                                                                | [`Java26Tests.java`](src/test/java/io/github/ufuk/java26/Java26Tests.java) |
